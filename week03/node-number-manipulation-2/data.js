...
const negativeNums = numbers.filter((num) => num < 0).sort((a, b) => a - b);
console.log("List of negatives = ", negativeNums);

const posNumbers = numbers.filter((num) => num > 0 && num % 6 === 0);
const sum = numbers.reduce((prev, curr) => prev + curr);
const average = sum / posNumbers.length;
console.log("Average of positive numbers 6 divisible = " + average);

const over600 = numbers.filter((num) => num > 600).reverse();
console.log("List of large numbers in reverse = ", over600);