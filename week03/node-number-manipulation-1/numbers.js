...
console.log("Sum = " + sum);
console.log("Positive Sum =" + posNumbers);
console.log("Even Sum = " + evenNumbers);
console.log("Sum of numbers above 400 = " + above400);
console.log("Sum of numbers between indexes 20 and 40 inclusively = " + between20and40);
